...
var totalcolUrl = "http://188.166.99.136:7010/arrears/totalArrearsByServiceClusters/"
...
const ArreasCluster = () => {
   ...
   var data = {
      labels: feederchart?.data?.map(x => x.service),
      datasets: [{
          label: `${feederchart?.data?.length} counts `,
          data: feederchart?.data?.map(x => x.count),
      ...
      {
        label:`${feederchart?.data?.length} total outstanding`,
        type: 'pie',
        data:feederchart?.data?.map(x => x.total_outstanding),
        radius: colors.ChartAnimation.radius,
        animations:colors.ChartAnimation.animations,
        dropShadow:colors.ChartAnimation.dropShadow,
        backgroundColor: colors.allChartPageColors.darkcolor,
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Total Arrears By Service Clusters</h3>
               
						
					<div className="d-inline-block align-items-center" style={{float: "right",marginRight: "-90%"}}>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Total Arrears By Service Clusters Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Total Arrears By Service Clusters Table</h4>
						</div>
				<div class="box-body">
						...
						<thead>
						  ...
						  <tbody key={index}>
							<tr>
							  ...
							  <td >{item.service}</td>
							  <td>{prepareValue('currency', item.count)}</td>
                                <td>{prepareValue('currency', item.total_outstanding)}</td>
							</tr>
						  </tbody>
                              ))
                         }
