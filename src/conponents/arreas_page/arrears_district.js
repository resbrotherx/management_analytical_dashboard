...
var totalcolUrl = "http://188.166.99.136:7010/arrears/totalArrearsByDistrict/"

const ArreasDistrict = () => {
   ...
   var data = {
      labels: feederchart?.data?.map(x => x.district_name),
      datasets: [{
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Total Arrears By District</h3>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Total Arrears By District Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Total Arrears By District Table</h4>
						</div>
				<div class="box-body">
