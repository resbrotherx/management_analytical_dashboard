...
var totalcolUrl = "http://188.166.99.136:7010/billed-units/totalBilledUnitsByDistrict/"
...
const BillDistrict = () => {
   ...
   var data = {
      ...
      datasets: [{
          label: `${feederchart?.data?.length} bill records `,
      ...
      {
        label:`${feederchart?.data?.length} billed amount`,
        type: 'doughnut',
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Total Billed Units By District</h3>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Billed Units By District Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Billed Units By District Table</h4>
						</div>
				<div class="box-body">
