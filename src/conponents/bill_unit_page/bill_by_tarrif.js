...
var totalcolUrl = "http://188.166.99.136:7010/billed-units/totalBilledUnitsByTariff/"
...
const Tarrif = () => {
   ...
   var data = {
      ...
      datasets: [{
          label: `${feederchart?.data?.length} total amount`,
          data: feederchart?.data?.map(x => x.total_amount),
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Billed Units By Tariff</h3>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Billed Units By Tariff Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Billed Units By Tariff Table</h4>
						</div>
				<div class="box-body">
                        ...
                        <th>index</th>
						  ...
						  <tbody key={index}>
							<tr>
							  ...
							  <td>{item.records}</td>
                              <td>{prepareValue('currency', item.total_amount)}</td>
							</tr>
						  </tbody>
                              ))
                         }
