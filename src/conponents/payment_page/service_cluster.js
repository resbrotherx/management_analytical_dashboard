...
var totalcolUrl = "http://188.166.99.136:7010/payments/totalCollectionByServiceCluster/"
...
const ServiceCluster = () => {
   ...
   var data = {
      labels: feederchart?.data?.map(x => x.collection),
      datasets: [{
          label: `names : ${feederchart?.data?.map(x => x.name)} total collection `,
          data: feederchart?.data?.map(x => x.total_collection),
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Collection By Service Cluster</h3>
               
						
					<div className="d-inline-block align-items-center" style={{float: "right",marginRight: "-110%"}}>
               
							<ol className="breadcrumb">
                    <li className=" breadcrumb-item"> <input  value={charData} onChange={e => setDatepiker(e.target.value)} className="form-control"  type="date" style={{color:"#b5b5c3", border:"1px solid #29354a"}}/></li>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Collection By Service Cluster Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Collection By Service Cluster Table</h4>
						</div>
				<div class="box-body">
                        ...
                        <th>total collection</th>
						  ...
						  <tbody key={index}>
							<tr>
							  ...
							  <td >{item.name}</td>
							  <td>{prepareValue('currency', item.collection)}</td>
                       <td>{prepareValue('currency', item.total_collection)}</td>
							</tr>
						  </tbody>
                              ))
                         }
