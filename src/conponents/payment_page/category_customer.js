...
var totalcolUrl = "http://188.166.99.136:7010/payments/totalCollectionByCustomers/"
...
const CustomerType = () => {
   ...
   var data = {
      labels: feederchart?.data?.map(x => x.customer_category),
      datasets: [{
          label: `total collection : ${feederchart?.data?.map(x => x.total_collection)} collection `,
          data: feederchart?.data?.map(x => x.collection),
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Collection By Customers</h3>
               
						
					<div className="d-inline-block align-items-center" style={{float: "right",marginRight: "-125%"}}>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Collection By Customers Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Collection By Customers Table</h4>
						</div>
				<div class="box-body">
                        ...
                        <th>total collection</th>
						  ...
						  <tbody key={index}>
							<tr>
							  ...
							  <td >{prepareValue('currency', item.customer_category)}</td>
