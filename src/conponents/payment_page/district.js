...
var totalcolUrl = "http://188.166.99.136:7010/payments/totalCollectionByDistrict/"
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Collection By District</h3>
               
						
					<div className="d-inline-block align-items-center" style={{float: "right",marginRight: "-135%"}}>
		...
		<section className="content">		    
				...
				<div className="col-xl-6 col-12">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Collection By District Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Collection By District Table</h4>
						</div>
				<div class="box-body">
