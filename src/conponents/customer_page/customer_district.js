...
var totalcolUrl = "http://188.166.99.136:7010/customer/totalCustomersByDistrict/"
...
const CustomerDistrict = () => {
   ...
   var data = {
      ...
      datasets: [{
          label: `${feederchart?.data?.length} total records `,
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Total Customers By District</h3>
		...
		<section className="content">		    
				...
				<div className="col-12 col-xl-8">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Total Customers By District Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Total Customers By District Table</h4>
						</div>
				<div class="box-body">
