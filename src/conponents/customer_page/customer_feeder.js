...
var totalcolUrl = "http://188.166.99.136:7010/customer/totalCustomersByFeeder/"

const CustomerFeeder = () => {
   ...
   var data = {
      ...
      datasets: [{
          label: `${feederchart?.data?.length} total customer `,
          data: feederchart?.data?.map(x => x.total_customer),
     ...
     <div className="content-wrapper">
	  <div className="container-full">
		<div className="content-header">
			<div className="d-flex align-items-center">
				<div className="me-auto">
					<h3 className="page-title">Total Customers By Feeder</h3>
		...
		<section className="content">		    
				...
				<div className="col-12 col-xl-8">
					<div className="box">
						<div className="box-header with-border">
							<h4 className="box-title">Total Customers By Feeder Chart</h4>
                   </div>
            ...
            <div class="box">
				<div className="box-header with-border">
							<h4 className="box-title">Total Customers By Feeder Table</h4>
						</div>
				<div class="box-body">
						...
						<thead>
						  ...
						  <tbody key={index}>
							<tr>
							  ...
							  <td >{item.feeder}</td>
							  <td>{prepareValue('currency', item.total_customer)}</td>
							</tr>
						  </tbody>
                              ))
                         }
